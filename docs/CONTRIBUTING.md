...
uv venv $SCRATCH/venvs/molflow

# Activate and install
source $SCRATCH/venvs/molflow/bin/activate
uv pip install -e ".[dev]"
...
# Run with coverage
pytest --cov=molflow --cov-report=html
...
- Mirror the source structure (e.g., `src/molflow/utils.py` → `tests/test_utils.py`).
